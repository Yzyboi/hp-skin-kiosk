...
// appends the JSON record. fields: { name, zone, motifZone }.
// svgBuffer: raw bytes of the uploaded .svg file.
function addDesign({ name, zone, motifZone, svgBuffer }) {
...
function updateDesign(id, { name, zone, motifZone, svgBuffer }) {
  const designs = readDesigns();
